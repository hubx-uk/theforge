...
export default function Footer({ showClientPortal = true }: { showClientPortal?: boolean }) {
  return (
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid sm:grid-cols-2 lg:grid-cols-6 gap-10 mb-12">
          <div className="flex flex-col gap-4">
            <Link href="/" className="flex items-center gap-2" style={{ letterSpacing: '-0.03em' }}>
              <ForgeLogo size={26} />
            ...
            <p className="text-sm leading-relaxed" style={{ color: 'var(--text-muted)' }}>
              A software development and digital marketing studio building systems that grow small and medium-sized businesses worldwide.
            </p>
            <a
                ...
                {group === 'Explore' && showClientPortal && (
                  <li>
                    <Link
                      ...
                      style={{ color: 'var(--accent)' }}
                      onMouseEnter={e => (e.currentTarget.style.color = 'var(--accent-alt)')}
