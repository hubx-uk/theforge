...
export function AdminLoginForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      {error && (
        <div className="rounded-xl p-3 text-sm font-medium text-center" style={{ background: 'rgba(254,127,45,0.1)', color: 'var(--accent)', border: '1px solid rgba(254,127,45,0.2)' }}>
          {error}
        </div>
      )}
      <div>
        ...
        <div className="relative">
          ...
          <input
            type="email" name="email" required placeholder="admin@theforge.io"
            className="forge-input" style={{ paddingLeft: '2.75rem' }}
          />
        </div>
      </div>
      <div>
        ...
        <div className="relative">
          ...
          <input
            ...
            className="forge-input" style={{ paddingLeft: '2.75rem', paddingRight: '2.75rem' }}
          />
      ...
      <button type="submit" disabled={loading}
        className="btn-fire w-full flex items-center justify-center gap-2 py-3 rounded-xl disabled:opacity-60">
