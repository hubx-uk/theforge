  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4" style={{ background: 'var(--bg-base)' }}>
      ...
      <div aria-hidden className="pointer-events-none fixed inset-0"
        style={{ background: 'radial-gradient(ellipse 70% 50% at 50% 50%, rgba(254,127,45,0.06) 0%, transparent 70%)' }} />

      <div className="relative z-10 w-full max-w-[400px]">
        {/* Logo */}
        <div className="flex flex-col items-center mb-8">
          <div className="w-14 h-14 rounded-2xl flex items-center justify-center mb-4"
            style={{ background: 'var(--accent)', boxShadow: '0 0 40px rgba(254,127,45,0.4)' }}>
          ...
          <p className="text-sm mt-1" style={{ color: 'var(--text-muted)' }}>Studio admin — authorised access only</p>
        </div>
