...
export default async function AdminDashboard() {
  ...
  const [
    ...
    supabaseAdmin
      .from("projects")
      .select("id, name, status, clients(name), updated_at")
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  <span
                    ...
                    style={{
                      background: `${STATUS_COLOR[p.status as string]}18`,
                      color: STATUS_COLOR[p.status as string],
                    }}
                  >
