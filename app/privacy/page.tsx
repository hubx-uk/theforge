  ...
  return (
    <PageShell>
      ...
      <section className="max-w-3xl mx-auto px-6 pb-28 prose-forge">
        ...
        <p>
          When you fill out our contact form or start a project, we collect:
        </p>
        <ul>
          ...
          <li>
            Usage data collected automatically (pages visited, browser type, IP
            address)
          </li>
        </ul>
        ...
        <p>
          Contact form submissions and project data are stored in Supabase
          (PostgreSQL), hosted in a secure cloud environment. Payment records
          are managed by Stripe and subject to Stripe&apos;s own privacy policy.
        </p>
        <p>
          We retain your data for as long as is necessary to deliver our
          services and comply with legal requirements. You may request deletion
          at any time.
        </p>
        ...
        <h2>5. Cookies</h2>
        <p>
          We use minimal, functional cookies required for the website to operate
          correctly. We do not use advertising or tracking cookies. Your theme
          preference (light/dark) is stored in your browser&apos;s localStorage.
        </p>
        ...
        <p>
          ...
          <a href="mailto:privacy@theforge.ng">privacy@theforge.ng</a>.
        </p>

        <h2>7. Security</h2>
        <p>
          We implement industry-standard security measures including HTTPS,
          database row-level security (RLS), and access controls. However, no
